  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-[#fafafa] p-6 font-sans text-gray-900">
      <motion.div
        ...
        className="w-full max-w-md bg-white p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-center"
      >
        {state === "verifying" && (
          <>
        ...
        {state === "success" && (
          <>
            ...
            <p className="text-gray-500 text-sm mb-8">You&apos;re all set — sign in to your workspace.</p>
            <Link href="/login">
              <button className="w-full py-3.5 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-black active:scale-[0.98] transition-all">
                Go to sign in
              </button>
            </Link>
          </>
        ...
        {state === "error" && (
          <>
            ...
            <p className="text-gray-500 text-sm mb-8">This verification link is no longer valid. You can request a fresh one from the sign-in page.</p>
            <Link href="/login">
              <button className="w-full py-3.5 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-black active:scale-[0.98] transition-all">
                Back to sign in
              </button>
