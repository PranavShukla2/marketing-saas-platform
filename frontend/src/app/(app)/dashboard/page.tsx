    ...
    <div className="w-full text-[var(--ink)] relative pb-24">
      ...
      <header className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center justify-between gap-5 mb-8">
        <div className="flex items-center gap-4">
          ...
          <label
            htmlFor="logo-upload"
            className="cursor-pointer flex items-center justify-center w-12 h-12 bg-[var(--surface)] border border-[var(--line)] rounded-2xl shadow-sm hover:border-[var(--violet)] transition-all overflow-hidden flex-shrink-0"
          >
          ...
          <div>
            ...
            {activePlatform === "google" && view.properties?.length > 0 && (
              <select
                ...
                disabled={isDemo}
                className="mt-1.5 bg-[var(--surface)] border border-[var(--line)] text-[var(--ink-2)] text-xs rounded-lg px-2.5 py-1.5 shadow-sm disabled:opacity-60"
              >
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            disabled={syncing}
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl border border-[var(--line)] bg-[var(--surface)] text-[var(--ink-2)] hover:text-[var(--ink)] hover:shadow-sm transition-all text-xs font-medium disabled:opacity-60"
          >
            <motion.svg
          ...
          <button onClick={downloadCSV} className="px-3.5 py-2 rounded-xl border border-[var(--line)] bg-[var(--surface)] text-[var(--ink-2)] hover:text-[var(--ink)] hover:shadow-sm transition-all text-xs font-medium">
            Export CSV
          </button>
          ...
          <button onClick={handleConnectGoogle} className="px-3.5 py-2 rounded-xl border border-[var(--line)] bg-[var(--surface)] text-[var(--ink-2)] hover:text-[var(--ink)] hover:shadow-sm transition-all text-xs font-medium flex items-center gap-2">
      ...
      {/* ---------------- Source switcher ---------------- */}
      <div className="max-w-7xl mx-auto mb-6">
        <div className="inline-flex gap-1 bg-[var(--surface)] border border-[var(--line)] p-1 rounded-2xl shadow-sm">
          {SOURCES.map((src) => {
