...
const platformConfig: Record<string, { name: string; color: string; gradient: string; icon: React.ReactNode }> = {
  ...
  meta: {
    ...
    icon: (
      <svg className="w-10 h-10" fill="#1877F2" viewBox="0 0 256 256">
        <path d="M239.5,123.6a55.1,55.1,0,0,0-50.6-55.8h-2.1a58,58,0,0,0-43.1,19.3L128,103.7l-15.7-16.6A58,58,0,0,0,69.2,67.8H67A55.1,55.1,0,0,0,16.5,123.6v4.8a55.1,55.1,0,0,0,50.5,55.8h2.2a58,58,0,0,0,43.1-19.3L128,148.3l15.7,16.6a58,58,0,0,0,43.1,19.3h2.2a55.1,55.1,0,0,0,50.5-55.8Z" />
      </svg>
    )
  },
  linkedin: {
