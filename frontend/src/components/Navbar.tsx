...
export default function Navbar() {
  ...
  return (
    <nav className="w-full h-16 flex items-center justify-between px-6 md:px-10 border-b border-gray-100 bg-white/80 backdrop-blur-md fixed top-0 left-0 z-50">
      ...
      <div className="flex items-center space-x-4">
        {isAuthenticated ? (
          ...
          <>
            ...
            <Link href="/register" className="bg-black text-white text-sm font-medium px-5 py-2 rounded-full hover:bg-gray-800 transition-colors shadow-sm">
              Get Started
            </Link>
          </>
        )}
